...
function WriteExam() {
  ...
  const calculateResult = async () => {
    try {
      ...
      let verdict = 'Pass';
      if (
        correctAnswers.length * (examData.totalMarks / questions.length) <
      ...
      const response = await addReport({
        // go to reportsRoute/reportsmodel to see the format to send data
        exam: params.id,
        result: tempResult,
        user: user._id,
      });
          ...
          <div className='flex flex-col gap-2'>
            <div className='flex justify-between'>
              <h1 className='text-2xl'>
                ...
                {/* go to AddEditQuestion.js to see why we use .name, .correctOptions,.exam */}
              </h1>
              ...
              <div className='marks'>
                ...
                <h1 className='text-md'>
                  ...
                  {result.correctAnswers.length *
                    (examData.totalMarks / questions.length)}
                </h1>
                <h1 className='text-md'>
